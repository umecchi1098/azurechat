...
export const PromptHero = () => {
  return (
    <Hero
      ...
      description={
        `プロンプトテンプレートは、業務に役立つ質問やアイデアを提供します。
        よく使う機能やアイデアを保存しておくことで、作業効率を向上させることができます。
      ...
      <HeroButton
        ...
        onClick={() =>
          promptStore.updatePrompt({
            ...
            name: "夢幻的な街",
            description:
              `カラフルな建物と緑の木々があるミニチュアの街を作成します。
              画像の中心には[iconic building]があり、周囲にはぼやけた背景と多くの[Native tree name]の木があります。
              画像は夢幻的で夢のような雰囲気があり、浅い被写界深度と高い視点で撮影されています。
              街はおもちゃやモデルのように見え、さまざまなスタイルと形の建物があります。`,
            isPublished: false,
            type: "PROMPT",
            userId: "",
          })
